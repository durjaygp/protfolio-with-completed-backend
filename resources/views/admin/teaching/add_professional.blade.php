...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{route('save.professional.teaching')}}" method="post">
                @csrf
                ...
                <div class="row">
                    <div class="col-md-8 offset-2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="title" placeholder="Please insert Professional Development title" value="{{$professional->title}}">
                        </div>
                        <div class="form-group">
                            <label for="formGroupExampleInput">Professional Development Post Description</label>
                            <textarea name="description" id="description" cols="30" rows="10"  class="form-control">{{$professional->description}}</textarea>
                        </div>
                        <div class="form-group">
